"""TransNetV2 model definition, copied unchanged from the official repository.

Source: https://github.com/soCzech/TransNetV2 (inference-pytorch/transnetv2_pytorch.py)
Paper: Soucek & Lokoc, "TransNet V2: An effective deep network architecture for fast
shot transition detection" (2020).
"""
